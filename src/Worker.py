...
class Worker:
  ...
  def __cli_parser(self):
    ...
    parser.add_argument("--pcross", type = float, help="NSGA-II crossover probability.", default = .8)
    parser.add_argument("--etac", type = float, help="NSGA-II crossover distribution index.", default = 50)
    parser.add_argument("--pmut", type = float, help="NSGA-II mutation probability.", default = .5)
