...
class TwoStepsAlsWcHdlGenerator(HDLGenerator):
    ...
    def generate_axhdl(self, **kwargs):
        ...
        for i, outer_conf in enumerate(kwargs['outer_configurations']):
            ...
            assertions_conf = [ kwargs['inner_configuration'][c] for c in outer_conf ]
