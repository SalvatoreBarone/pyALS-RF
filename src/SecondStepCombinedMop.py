...
class SecondStepCombinedMop(SecondStepBaseMop, pyamosa.Problem):
    def __init__(self, classifier, error_config, fst_opt_conf, fst_term_criterion, outdir):
        SecondStepBaseMop.__init__(self, classifier, error_config, fst_opt_conf, fst_term_criterion, outdir)
        ...
        pyamosa.Problem.__init__(self, n_vars, [pyamosa.Type.INTEGER] * n_vars, [0] * n_vars, ub, 3, 1)
