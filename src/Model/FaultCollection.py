...
class FaultCollection:
    ...
    def sample_faults(self, type_of_faults: str = 0, nro_faults = 50):
        logger = logging.getLogger("pyALS-RF")
        ...
        for f in tqdm(faults, desc = "Storing sampled fault sites"):
    ...
    def faults_to_json5(self, list_feature_names, list_tree_names, list_class_names, out_path):
        logger = logging.getLogger("pyALS-RF")
        ...
        for tree_name in tqdm(list_tree_names, desc = "Converting DBs fault sites into DICT JSON"):
            ...
            for f in fault_list:
                ...
                if list(f.keys())[0] == tree_name:
                    dict_per_tree.update({f[tree_name] : True})
                ...
                for f in fault_list: 
                    ...
                    if list(f.keys())[0] == tree_name:
                        ...
                        if list(dict_minterm.keys())[0] == class_name:
                            dict_per_class.update({dict_minterm[class_name] : True})
